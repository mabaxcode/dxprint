...
<head>
    ...
    <!-- Theme Style -->
    <link rel="stylesheet" type="text/css" href="<?= base_url(); ?>assets-office/css/animate.min.css">
    <link rel="stylesheet" type="text/css" href="<?= base_url(); ?>assets-office/css/animation.css">
    ...
    <!-- Font -->
    <link rel="stylesheet" href="<?= base_url(); ?>assets-office/font/fonts.css">

    <!-- Icon -->
    <link rel="stylesheet" href="<?= base_url(); ?>assets-office/icon/style.css">
