                                    ...
                                    <table id="example" class="list-product-table">
                                        ...
                                        <tbody style="font-size: 200%;">
                                            <? foreach ($orders as $key) { ?>
                                                    ...
                                                    <tr>
                                                        <td><?=ucfirst($product['name'])?><br><p><strong>Order ID : #<?= $key['id']?></strong></p></td>
                                                        <td>RM<?= $product['price']?></td>
                                                        <td><?= $key['quantity']?></td>
                                                        <td>RM<?=number_format($key['payment'],2)?></td>
                                                        <td>
                                                            <? if($key['status'] == "PAID" || $key['status'] == "PACKAGING"){ ?>
                                                            <?
                                                                if ($key['status'] == "PAID") {
                                                                    $a = "Paid";
                                                                } else {
                                                            ...
                                                            ?>
                                                            <div class='block-available bg-1 fw-7'><?=$a?></div>
                                                            <? } else { ?>
                                                            <div class="block-tracking bg-1">Shipped</div>
                                                            <? } ?>
                                                        ...
                                                        */?>
                                                        <td>
                                                            <? if($key['status'] == "PAID"){ ?>
                                                            <button class="tf-button" onclick="packThisOrder('<?=$key['id']?>')" type="submit" style="padding: 18px; height: 12px;">Packaging This Order</button> 
                                                            <? } elseif ($key['status'] == "PACKAGING") { ?>
                                                            <button class="tf-button" onclick="shipThisOrder('<?=$key['id']?>')" type="submit" style="padding: 18px; height: 12px;">Ship This Order</button> 
                                                            <? } else { ?>
                                                            <p>
