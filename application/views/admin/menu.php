<div class="center-item">
    <ul class="">
        ...
        <li class="menu-item has-children <? if($this->uri->segment(2) == 'allUser'){ echo 'active'; } ?>">
            <a href="javascript:void(0);" class="menu-item-button">
                <div class="icon"><i class="icon-user"></i></div>
                <div class="text">Users</div>
            </a>
            <ul class="sub-menu">
                <li class="sub-menu-item <? if($this->uri->segment(2) == 'allUser'){ echo 'active'; } ?>">
                    <a href="<?=base_url('manage/allUser')?>" class="">
        ...
        <li class="menu-item <? if($this->uri->segment(2) == 'accSetting'){ echo 'active'; } ?>">
            <a href="<?=base_url('manage/accSetting')?>" class="">
                <div class="icon">
