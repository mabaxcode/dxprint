                                    ...
                                    <div class="wg-box mb-30">
                                        ...
                                        <fieldset class="category">
                                            ...
                                            <select name="category" required>
                                                ...
                                                <option value="1" <? if($product['category'] == '1'){echo"selected";} ?>>T - Shirt Lengan Panjang</option>
                                                <option value="2" <? if($product['category'] == '2'){echo"selected";} ?>>T - Shirt Lengan Pendek</option>
                                                <option value="3" <? if($product['category'] == '3'){echo"selected";} ?>>Jersey</option>
