...
<body class="preload-wrapper">
                    ...
                    <div class="col-lg-3">
                        <div class="wrap-sidebar-account">
                            <ul class="my-account-nav">
                                ...
                                <li><a href="<?= base_url('main/accDetails')?>" class="my-account-nav-item active">Account Details</a></li>
                            ...
                            <div class="">
                                <form id="form-password-change">
                                    <div class="tf-field style-1 mb_15">
                                        <input class="tf-field-input tf-input" placeholder=" " value="<?=$user['name']?>" type="text" id="property1" name="name">
                                        <label class="tf-field-label fw-4 text_black-2" for="property1">Name</label>
                                    </div>
                                    <div class="tf-field style-1 mb_15">
                                        <input class="tf-field-input tf-input" placeholder=" " value="<?=$user['email']?>" type="email" id="property3" name="email">
                                        <label class="tf-field-label fw-4 text_black-2" for="property3">Email</label>
                                    </div>
                                    <div class="tf-field style-1 mb_15">
                                        <input class="tf-field-input tf-input" placeholder=" " value="<?=$user['phone_no']?>" type="text" id="property2" name="phone_no">
                                        <label class="tf-field-label fw-4 text_black-2" for="property2">Phone No.</label>
                                    </div>
                                ...
                                <div class="mb_20">
                                        <a class="tf-btn w-100 radius-3 btn-fill animate-hover-btn justify-content-center" onclick="updateAccount();">Save Changes</a>
                                    </div>
                            </div>
                        </div>
                    </div>
    ...
    <script type="text/javascript">
        ...
        function updateAccount() {
            var formDataAcc = $("#form-password-change").serialize();
            $.ajax({
                url: base_url + 'main/updateAcc',
                type: 'POST',
                data: formDataAcc,
                dataType:"json",
                success: function(data) {
                    if (data.status == true) {
                        Swal.fire({
                            title: "Success!",
                            text: "Your account details has been update.",
                            icon: "success"
                        });
                    } else {
                        alert ("error on add");
