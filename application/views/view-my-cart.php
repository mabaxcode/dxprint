                        ...
                        <div class="tf-mini-cart-items">
                            ...
                            <div class="tf-mini-cart-item">
                                <div class="tf-mini-cart-info">
                                    ...
                                    <div class="meta-variant"><?= ucfirst($cart['color'])?></div>
                                    ...
                                    <div class="tf-mini-cart-btns">
                                        <div class="wg-quantity small">
                                            <span class="btn-quantity minus-btn" onclick="decrease('<?= $cart['id']?>')">-</span>
                                            <input type="text" name="number" id="cart-quantity-product-<?= $cart['id']?>" value="<?= $cart['quantity']?>">
                                            <span class="btn-quantity plus-btn" onclick="increase('<?= $cart['id']?>')">+</span>
                                        </div>
                ...
                <div class="tf-mini-cart-bottom">
                    ...
                    <div class="tf-mini-cart-bottom-wrap">
                        <div class="tf-cart-totals-discounts">
                            ...
                            <div class="tf-totals-total-value fw-6">RM<?= $subtotal?></div>
                        </div>
                        ...
                        <div class="tf-mini-cart-view-checkout">
                            ...
                            <a href="<?= base_url('main/checkout')?>" class="tf-btn btn-fill animate-hover-btn radius-3 w-100 justify-content-center"><span>Check out</span></a>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    {
        // var quantityInput = $("#cart-quantity-product-"+id).val();
        var quantityInput = parseInt($("#cart-quantity-product-" + id).val(), 10);
        var finalQuantity = quantityInput - 1;

        $.ajax({
            url: base_url + 'main/updateCartQuantity',
            type: 'POST',
            data: {id:id,finalQuantity:finalQuantity},
