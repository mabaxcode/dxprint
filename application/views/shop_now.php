    ...
    <div id="wrapper">
        ...
        <div class="tf-page-title">
            <div class="container-full">
                ...
                <p class="text-center text-2 text_black-2 mt_5">Shop through our latest selection of Design</p> 
            </div>
        </div>
        <!-- /page-title -->
            ...
            <div class="container">
                ...
                <div class="wrapper-control-shop">
                    ...
                    <div class="grid-layout wrapper-shop" data-grid="grid-4">
                        ...
                        <? $product_img = get_any_table_array(array('product_id' => $key['product_id'], 'is_submit' => '1'), 'product_image'); ?>
                        <div class="card-product" data-price="16.95" data-size="s m l xl" data-color="white purple black">
                            <div class="card-product-wrapper">
                                <a href="<?= base_url('main/productDetail/'.$key['product_id'])?>" class="product-img">
                                    <? foreach ($product_img as $img) { ?>
                                    <? $img_url = base_url() . $img['path'] . "/" . $img['filename']; ?>
                                    <img class="lazyload img-product" data-src="<?=$img_url?>" src="<?=$img_url?>" alt="image-product">
                                    <? } ?>
                                </a>
                                <div class="size-list">
                                    <span>S</span>
                            ...
                            <div class="card-product-info">
                                <a href="product-detail.html" class="title"><?=ucfirst($key['name'])?></a>
                                <span class="price">RM<?=number_format($key['price'],2)?></span>
