                        ...
                        <form class="form-checkout">
                            <div class="box grid-2">
                                ...
                                <fieldset class="fieldset">
                                    ...
                                    <input type="text" id="last-name" value="<?= $info['email']?>" disabled>
                                </fieldset>
                            </div>
                            <fieldset class="box fieldset">
                                <label for="country">Country/Region</label>
                                <input type="text" id="last-name" value="<?= $address['country']?>" disabled>
                            </fieldset>
                            <!-- <fieldset class="box fieldset">
                            ...
                            <div class="box grid-2">
                                ...
                                <fieldset class="box fieldset">
                                    ...
                                    <input type="number" id="phone" value="<?= $info['phone_no']?>" disabled>
                                </fieldset>
                            </div>
