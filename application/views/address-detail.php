                            ...
                            <div class="text-center widget-inner-address">
                                ...
                                <form class="show-form-address wd-form-address" id="formnewAddress">
                                    ...
                                    <div class="box-field">
                                        <div class="tf-field style-1">
                                            <input class="tf-field-input tf-input" placeholder=" " type="text" id="address" name="addressunit" required>
                                    ...
                                    <div class="box-field">
                                        <label for="country" class="mb_10 fw-4 text-start d-block text_black-2 ">State</label>
                                        <div class="select-custom">
                                            <select class="tf-select w-100" id="country" name="state" data-default="">
                                                <option value="">Select State</option>
                                                <? foreach($states as $state){ ?>
                                                <option value="<?= $state['code_id']?>"><?= $state['code_desc']?></option>
                                                <? } ?>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="box-field">
                                        <div class="tf-field style-1">
                                            ...
                                            <label class="tf-field-label fw-4 text_black-2" for="AddressZipNew">Postcode</label>
                                        </div>
                                    </div>
                                    <?/*
                                    ...
                                    */?>
                                    <div class="d-flex align-items-center justify-content-center gap-20">
                                        <a class="tf-btn btn-fill animate-hover-btn" onclick="addNewAddress()">Add address</a>
                                ...
                                <div class="list-account-address">
                                    <div class="account-address-item">
                                        ...
                                        <p>
                                            <?
                                            $state_desc = get_ref_code('state', $address['state']);
                                            echo $state_desc;
                                            ?>
                                        </p>
                                        <p><?= $info['email']?></p>
                                        <p class="mb_10"><?= $info['phone_no']?></p>
                                        ...
                                        <form class="edit-form-address wd-form-address" id="formeditAddress" action="#">
                                            ...
                                            */?>
                                            ...
                                            <div class="box-field">
                                                <div class="tf-field style-1">
                                                    <input class="tf-field-input tf-input" placeholder=" " type="text" id="addressEdit" name="addressunit" value="<?= $address['address']?>" required>
                                                    <label class="tf-field-label fw-4 text_black-2" for="addressEdit">Address</label>
                                                </div>
                                            </div>
                                            <div class="box-field">
                                                <div class="tf-field style-1">
                                                    <input class="tf-field-input tf-input" placeholder=" " type="text" id="cityEdit" name="city" value="<?= $address['city']?>" required>
                                                    <label class="tf-field-label fw-4 text_black-2" for="cityEdit">City</label>
                                                </div>
                                            </div>
                                            <div class="box-field">
                                                <label for="countryEdit" class="mb_10 fw-4 text-start d-block text_black-2">State</label>
                                                <div class="select-custom">
                                                    <select class="tf-select w-100" id="country" name="state" data-default="">
                                                            <option value="">Select State</option>
                                                            <? foreach($states as $state){ ?>
                                                            <option value="<?= $state['code_id']?>" <? if($state['code_id'] == $address['state']){echo "selected";}else{echo "";} ?> ><?= $state['code_desc']?></option>
                                                            <? } ?>
                                                        </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="box-field">
                                                <div class="tf-field style-1">
                                                    <input class="tf-field-input tf-input" placeholder=" " type="text" id="AddressZipNew" name="postcode" value="<?= $address['postcode']?>" required>
                                            ...
                                            <div class="d-flex align-items-center justify-content-center gap-20">
                                                <button type="button" class="tf-btn btn-fill animate-hover-btn" onclick="updateAddress()">Update address</button>
